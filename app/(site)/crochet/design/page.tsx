...
const STITCH_STYLES = [
  {
    value: 'fan_shell',
    label: 'Arch & Fan Shell Stitch',
    desc: 'Ornate scalloped fan arches with delicate openwork lace openings.',
    image: '/stitches/fan-shell.jpg',
  },
  {
    value: 'ribbed_stitch',
    label: 'Ribbed Stitch (Back Loop)',
    desc: 'Elastic ridge texture with cozy stretch and clean parallel lines.',
    image: '/stitches/ribbed.jpg',
  },
  {
    value: 'cluster_block',
    label: 'Cluster Block Stitch',
    desc: 'Dense textured block pattern with plush raised stitch clusters.',
    image: '/stitches/cluster-block.jpg',
  },
  {
    value: 'lace_wave',
    label: 'Lace Fan Wave Stitch',
    desc: 'Lightweight breathable V-mesh fan lattice pattern.',
    image: '/stitches/blue-lace.jpg',
  },
  {
    value: 'checkerboard_gingham',
    label: 'Checkerboard / Gingham Tapestry Stitch',
    desc: 'Two-tone geometric block check pattern.',
    image: '/stitches/checkerboard.jpg',
  },
  {
